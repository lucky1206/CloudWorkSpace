...
public class PinyinUtil {
     ...
     * @return
     */
    public String getPingYinEx(String inputString) {
     ...
     * @return
     */
    public String cleanChar(String chines) {
    ...
    public String getPinYin4All(String name) {
        if (!name.equalsIgnoreCase("")) {
            String tmp = cleanChar(name);
            if (!tmp.equalsIgnoreCase("")) {
                String tempName = getPingYin(tmp);
                if (tempName.length() > 10) {
                    tempName = getPinYinHeadChar(tmp);
                }
                return tempName.toUpperCase();
            }

            /*int cTotal = getChineseCount(tmp);
            if (cTotal <= 4) {
                return getPingYin(tmp).toUpperCase();
            } else {
                return getPinYinHeadChar(tmp).toUpperCase();
            }*/
        }
        return "";
    }
    ...
    public static void main(String[] args) {
        ...
        String cnStr = "岸线开发利用";
        System.out.println(pinyinUtil.getPinYin4All(cnStr));
    }
}
